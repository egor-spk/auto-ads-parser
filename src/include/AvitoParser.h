#ifndef AUTO_ADS_PARSER_AVITOPARSER_H
#define AUTO_ADS_PARSER_AVITOPARSER_H

#include "IParser.h"
#include <Document.h>

class AvitoParser : public IParser
{
public:
    /**
     * @param link строка должна содержать поля в формате fmtlib для указания страницы
     */
    explicit AvitoParser(const char *link);
...
#endif //AUTO_ADS_PARSER_AVITOPARSER_H
